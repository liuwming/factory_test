...
DLLTEST_API rtt_handle_t rtt_connect(int timeout, int* err, int proto, char* ip)
{
...
DLLTEST_API int rtt_discon(rtt_handle_t hdl)
{
    rtt_conn_t *con = hdl;
 ...
 */
DLLTEST_API int rtt_send(rtt_handle_t hdl, rt_cmd_t* cmd)
{
    rtt_conn_t *con = hdl;
    int rc;
 ...
 */
DLLTEST_API int rtt_recv(rtt_handle_t hdl, rt_cmd_result_t* result, rt_cmd_type_t type)
{
    rtt_conn_t *con = hdl;
    int rc;
