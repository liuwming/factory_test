...
#else
    clnt_result(clnt, RT_CMD_CTRL_DEV, RT_ERR_OK);
    ctrl_dev(mac, CTRL_DEV_CMD_TEST_PASS);
#endif
...
#else
    clnt_result(clnt, RT_CMD_FAIL_DEV, RT_ERR_OK);
    ctrl_dev(mac, CTRL_DEV_CMD_TEST_FAIL);
#endif
